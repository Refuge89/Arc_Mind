...
bool HandleInfoCommand(BaseConsole * pConsole, int argc, const char * argv[])
{
	...
	pConsole->Write("======================================================================\r\n");
	pConsole->Write("ArcEmu Information: \r\n");
	pConsole->Write("======================================================================\r\n");
	// pConsole->Write("ArcEmu Revision Information %s/%s-%s-%s\r\n", BUILD_REVISION, CONFIG, PLATFORM_TEXT, ARCH);
...
bool HandleRestartLuaScripts(BaseConsole * pConsole, int argc, const char * argv[])
{
	sScriptMgr.restart_lua_scripts();
	return true;
}
#endif
