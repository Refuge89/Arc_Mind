...
// LocationExtra structure to select/list some units by using arrays and vector tables


// Channelers LocationExtra is list of spawn points of all 5 channelers casting spell on Magtheridon
struct LocationExtra Channelers[]=
{
...
struct LocationExtra CaveInPos[]=
{
...
struct LocationExtra CubeTriggers[]=
{
