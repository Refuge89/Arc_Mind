...
namespace SUNWELL_KALECGOS
{
	struct LocationExtra{
		float x,y,z;
		LocationExtra(float x,float y, float z)
		{
			LocationExtra::x = x;
			LocationExtra::y = y;
			LocationExtra::z = z;
	...
	LocationExtra spectralCoords(1724.94f,909.265f,-74.5588f);
	LocationExtra wp1(1703.69653f,869.224854f,65.416687f);
	LocationExtra wp2(1703.131348f,842.142822f,91.754280f);
	LocationExtra wp3(1752.924194f,754.499634f,181.749878f);
