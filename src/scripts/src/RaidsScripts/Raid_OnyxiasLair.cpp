...
static LocationExtra whelpLocationExtra[] =
{
        ...
        if(!m_whelpCooldown)
        {
            ...
            for(int i = 0; i < 6; i++)
            {
                cre = _unit->GetMapMgr()->GetInterface()->SpawnCreature(11262, 
                    whelpLocationExtra[i].x, whelpLocationExtra[i].y,
                    whelpLocationExtra[i].z, whelpLocationExtra[i].o,
                    true, false, 0, 0);
                if(cre)
                {
                ...
                cre = _unit->GetMapMgr()->GetInterface()->SpawnCreature(11262, 
                    whelpLocationExtra[5-i].x, whelpLocationExtra[5-i].y,
                    whelpLocationExtra[5-i].z, whelpLocationExtra[5-i].o,
                    true, false, 0, 0);
                if(cre)
                {
