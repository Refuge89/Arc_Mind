...
// Paths
// Eye Beam stuff
static LocationExtra EyeBeamPaths[]=
{
...
// Akama stuff
static LocationExtra ToIllidan[]= 
{
	{  },
...
// Illidan stuff
static LocationExtra ForIllidan[]= 
{
	{  },
		...
		if ((mIllidanAI != NULL && mScenePart <= 6) || mScenePart > 6)
		{
			...
			case 6:{
				...
				if (pAkama != NULL)
				{
					...
					pLocationExtra.x = IllidanX - X;
					pLocationExtra.y = IllidanY - Y;
					pLocationExtra.z = IllidanZ;
					pLocationExtra.o = 0.0f;

					pAkamaAI->AddWaypoint(CreateWaypoint(20, 0, Flag_Run, pLocationExtra));
