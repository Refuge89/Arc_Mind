...
bool Echeyakee(uint32 i, Spell* pSpell)
{
  ...
  if(en == NULL)
    return true;
  Creature* Echeyakee = pPlayer->GetMapMgr()->GetInterface()->GetCreatureNearestCoords( 459.78f, -3034.95f, 91.68f,3475 );
    if (Echeyakee==NULL)
    {
    Creature* EcheyakeeSpawn = sEAS.SpawnCreature( pPlayer, 3475, 459.78f, -3034.95f, 91.68f, 3.87f,120000 );
