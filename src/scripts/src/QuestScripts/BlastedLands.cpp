...
public:
  void OnQuestStart(Player* mTarget, QuestLogEntry * qLogEntry)
  {
	...
	if(!spawncheckcr)
	{
		Creature* general = sEAS.SpawnCreature(mTarget, 7750, -10619.0f, -2997.0f, 28.80f, 4.0f, 0);
	...
	if(!spawncheckgobj)
	{
		GameObject* generalsbox = sEAS.SpawnGameobject(mTarget, 141980, -10622.0f, -2994.0f, 28.60f, 4.0f, 4, 0, 0, 0, 0);
	...
	void GossipSelectOption(Object* pObject, Player* plr, uint32 Id, uint32 IntId, const char * EnteredCode)
	{
		...
		switch (IntId)
		{
			...
			case 1:
			{
				...
				if(!spawncheckcr)
				{
					Creature* general = sEAS.SpawnCreature(plr, 7750, -10619.0f, -2997.0f, 28.80f, 4.0f, 0);
					general->Despawn(3*60*1000, 0);
				}
				...
				if(!spawncheckgobj)
				{
					GameObject* generalsbox = sEAS.SpawnGameobject(plr, 141980, -10622.0f, -2994.0f, 28.60f, 4.0f, 4, 0, 0, 0, 0);
					sEAS.GameobjectDelete(generalsbox, 3*60*1000);
				}
			}
		}
