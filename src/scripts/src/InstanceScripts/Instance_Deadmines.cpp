...
*/
static LocationExtra PatrolLocationExtra[] = 
{
	{},
...
class RhahkZorAI : public MoonScriptCreatureAI
{
	...
	*/
	...
	void SetupPatrol(uint32 entry)
	{
		...
		if(Patrol == NULL)
			return;
		Patrol->AddWaypoint(Patrol->CreateWaypoint(1, 2500, Flag_Walk, PatrolLocationExtra[1]));
		Patrol->AddWaypoint(Patrol->CreateWaypoint(2, 2500, Flag_Walk, PatrolLocationExtra[2]));
...
class SneedAI : public MoonScriptCreatureAI
{
	...
	*/
	...
	void SetupPatrol(uint32 entry)
	{
		...
		if(Patrol == NULL)
			return;
		Patrol->AddWaypoint(Patrol->CreateWaypoint(1, 2500, Flag_Walk, PatrolLocationExtra[3]));
		Patrol->AddWaypoint(Patrol->CreateWaypoint(2, 2500, Flag_Walk, PatrolLocationExtra[4]));
		Patrol->ForceWaypointMove(1);
		Patrol = NULL;
	}
};
...
class GilnidAI : public MoonScriptCreatureAI
{
	...
	*/
	...
	void SetupPatrol(uint32 entry)
	{
		...
		Patrol->AddWaypoint(Patrol->CreateWaypoint(1, 2500, WALK, PatrolLocationExtra[5]));
		Patrol->AddWaypoint(Patrol->CreateWaypoint(2, 2500, WALK, PatrolLocationExtra[6]));
		Patrol->AddWaypoint(Patrol->CreateWaypoint(3, 2500, WALK, PatrolLocationExtra[7]));
		Patrol->ForceWaypointMove(1);
		Patrol = NULL;
	}
};
